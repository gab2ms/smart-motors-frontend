...
- ⏳ Menores (observação): Oficina "Lucro" inflado (OS com custo 0 — backlog #2). Acessório com `categoria='scooter'` soma R$30 NF indevido. Divergência preço cadastro×Tiny. 25 produtos sem FK `produto_precos_id`. Arredondamentos de centavos em empréstimo.
